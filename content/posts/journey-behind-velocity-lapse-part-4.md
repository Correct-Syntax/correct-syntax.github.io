...
Welcome to the fourth post in a series of "dev-log" posts of sharing my journey of creating [Velocity Lapse](https://velocitylapse.com), a time lapse app for Android. 
...
Multiple people had commented that Velocity Lapse was "no doubt" the best time lapse app for Android. Though, I didn't think it was appropriate to put that on the website...just yet, at least. :)
...
Upgrading to Flutter 3.10 was very straightforward. Flutter and Dart have been amazing to work with. Although I've run into a few areas that are rough around the edges, overall I couldn't be happier with the development experience building an app like this with Flutter.
...
- Talk to some people in the timelapse and mobile timelapse niche and see what they think of Velocity Lapse.
