...
For one thing, I had noticed that the user perceived crash rate was almost 6 percent which was over the Google Play threshold. Most of the issues were crashes during export. Obviously, not a great thing to see.

In short: Velocity Lapse just wasn't up to production quality yet. I didn't feel right launching with that much unstability.
...
On Roman Feb. 5th I raised the in-app purchase of Velocity Lapse PRO to $5.99. This turned out to be a very good decision as the app was indeed worth more than the previous $3.99, based on user feedback. Plus, it allowed me to invest in a test device to further improve Velocity Lapse.


### A new test device

Until this point, I had to rely on using friend's devices to test features that were limited to certain devices, such as 4K. However, relying on bits of time with someone else's device was not reliable or optimal. 

So I decided to look for a phone to buy which supports 4k video so I could test the full functionality of Velocity Lapse myself. Thankfully I had made enough money from the in-app purchase at this point to re-invest.
...
- **4K video support** so I could do the 4K testing
...
I was quite wary of buying from Back Market as some people online said it was a scam and I hadn't bought refurbished before. I also didn't like how difficult it seemed to contact them. However, in the end I decided to go for it.
...
I decided to keep the phone as I just didn't have the time to deal with the hassle of returning it and re-purchasing another model.

However, at the time of this writing I looked at their listing for the A53 (the same as I purchased) and it still lists the 3.3mm headphone jack. I thought they would have removed the false information by now. So, I contacted them again about it. Hopefully they fix the listing.

##### Conclusion

I haven't had any issues with the phone itself so far. Overall, ordering from Back Market was an OK experience. Not sure that I would buy from them again, though.
...
If you use software long enough, you will likely be inclined to write a bad review. I've done it myself more than I would have liked to. Problems *will* occur. Issues *will* arise. It's inevitable and unavoidable in software. But *please* don't be the user that does a "hit and run".

Probably *the most frustrating* reviews, in my opinion, are those that say a few negative words (sometimes using profanity) without explaining what the issues is, and then leave no way for the developer to follow up with them. These individuals either give a fake email or delete the review so you can't respond to their comments.
...
I updated the website, yet again. This time I went through the hassle and took the time to write proper copy for the homepage, explaining the benefits of the app. Honestly, it wasn't that hard since at this point the app has so many nice features and I had plently of user feedback to back it up.

3 separate people had commented through the feedback form that Velocity Lapse was "no doubt" the best time lapse app for Android. Though, I didn't think it was appropriate to put that on the website...just yet, at least. :)
...
Sometimes, I would get flooded with feature requests and it started to get overwhelming. So, I adopted a methodology of prioritizing them.

**1** the fixes that would otherwise cause a bad experience for **most users**, and 

**2** the features that would help **the most users**. 

Basically, "high-impact" requests. Oftentimes, that means working on something else in order to fix or add something, but it was a little less overwhelming.
...
On May 17th, 2023 I decided to raise the price of Velocity Lapse PRO to $7.99. At this point, the app was beginning to be more fleshed out and included saving to SD card as a PRO feature. 


### Flutter 3.10

Upgrading to Flutter 3.10 was very straightforward. (I'm not even sure why I included this section).

Seriously, though, Flutter and Dart has been amazing to work with. Although I've run into a few areas that are rough around the edges, overall I couldn't be happier with the development experience building an app like this with Flutter.
...
Naturally, I should do a brief look back at the first year of developing Velocity Lapse, as well as a look forward.
...
- Total downloads since the app was first public on Google Play (since Aug. 2022): **21,200+**
...
Thank you for reading. I hope you've enjoyed this post and have gained something from this journey so far as I have. **I may or may not do a part 5 of this series. Let me know in the comments below if you'd like me to continue this series.**
